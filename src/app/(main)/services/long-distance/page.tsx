          ...
          <div className="lg:w-1/2 w-full relative bg-white">
            <div className="px-5 md:px-10 lg:px-16 py-10 md:py-14 lg:py-16">
              ...
              <p
                ...
                style={{ color: "#2D3748" }}
              >
                Some moves go beyond the lower 48. Through our international
                shipping capabilities, Scanio carries households and
                businesses well past state lines, by land, by sea, and by
                air. Whether you are relocating to another state or another
                continent, we handle the logistics, customs documentation,
                and careful handling that a long distance move demands.
              </p>
            </div>
          </div>
        </div>
